...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <h3 class="text-center text-uppercase mt-4">Cancella una persona con ID specifico</h3>
        <div id="divForm" class="w-100 d-flex justify-content-center mt-3">
            <form id="form" class="mt-2" method="post" action="/personas/">
                ...
                <table class="table table-borderless">
                    <tr>
                        <td>
                            <label for="deleteId" class="mr-1">Id da cercare:</label>
                        </td>
                        <td>
